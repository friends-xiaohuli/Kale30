...
execute if score kale.state kale.DEBUG matches 1 run execute if score kale.state kale.PlayerPosN matches 1 run tellraw @a [{"text": "执行成功：","color":"green"},{"selector": "@s" }]
