...
#lag掉落主手物品
execute if predicate kale:10pa run scoreboard players add kale.LAGITEMtime kale.TimeState 1
#lag范围清物品
execute if predicate kale:30pa run scoreboard players add kale.LAGtime kale.TimeState 1
#主回溯
...
#lag掉落主手物品
execute if score kale.LAGITEMtime kale.TimeState matches 600 run function kale:game/item/init
...
execute if score kale.LAGtime kale.TimeState matches 1221.. run scoreboard players set kale.LAGtime kale.TimeState -1
